...
from main import SMOKE_LIMITS, expand_dataset_names
...
def main(*argv: str):
    ...
    if not args.load and not args.eval and not args.train_ngram:
        raise ValueError(
            "No task selected. Use --load <dataset_name>, --eval --dataset <dataset_name>, "
